        ...
        <>
            ...
            <div className="pt-30">
                ...
                <input type="email" className="form-control rounded-pill text-lg"
                    aria-describedby="email" placeholder="Enter your email address" required
                    value={email} onChange={text => setEmail(text.target.value)}/>
            </div>
            <div className="pt-30">
                <label className={className.label}>Password</label>
                <input type="password" className="form-control rounded-pill text-lg" required
            ...
            <div className="button-group d-flex flex-column mx-auto pt-50">
                <button className="btn btn-sign-up fw-medium text-lg text-white rounded-pill mb-16"
                    type="button" role="button" onClick={onSubmit}>Continue</button>
                <Link href="/sign-in">
